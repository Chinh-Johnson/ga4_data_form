...
const SOURCE_PROJECT = "privacy-learn" /* specify a value here only in case your source data sits in a project other than the default defined in workflow_settings.yaml defaultDatabase variable. You would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
const SOURCE_DATASET = "analytics_446825476"; /* the database containing the GA4 BigQuery exports */
...
const START_DATE = 20250109; /* data will be pulled starting this date */
